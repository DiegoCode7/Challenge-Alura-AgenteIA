# 🚀 Agente IA - Asistente de supermarket

Sistema de recuperación aumentada por IA (RAG) que permite consultar **documentos internos** y el **inventario del supermarket** en lenguaje natural, usando embeddings, PostgreSQL + pgvector, pandas/matplotlib y modelos LLM locales con Ollama.
